...
#         print(f"Receiver: Acknowledgment for packet {seq_num} is lost.")
#     else:
#         ack = str(seq_num)
#         receiver_socket.sendto(ack.encode(), addr)
#         print(f"Receiver: Sent acknowledgment for packet {seq_num}")
...
#     if seq_num == expected_seq_num:
#         print(f"Receiver: Received packet with sequence number {seq_num}: {message}")
#         expected_seq_num += 1
#         send_acknowledgment(seq_num, addr)
#     else:
#         print(f"Receiver: Received out-of-order packet {seq_num}. Discarding.")
