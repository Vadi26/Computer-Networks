...
# base = 0
# next_seq_num = 0
# packets = [f"Packet {i}" for i in range(window_size*3)]
# acked = [False] * window_size

# def send_packets():
#     global next_seq_num, base
#     while base < next_seq_num + window_size:
...
# base = 0
# next_seq_num = 0
# packets = [f"Packet {i}" for i in range(window_size)]
# acked = [False] * window_size
